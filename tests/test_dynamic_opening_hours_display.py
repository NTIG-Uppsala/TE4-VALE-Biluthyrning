...
class TestOpeningHours(TemplateTest):
    ...
    def testWeekdays(self) -> None:
        ...
        self.setAndTestTime(2024, 9, 2, 9, 58, expected=["stängt", "10:00"])
        ...
        self.setAndTestTime(2024, 9, 6, 9, 58, expected=["stängt", "10:00"])
        ...
        self.setAndTestTime(2024, 9, 7, 11, 58, expected=["stängt", "12:00"])
        ...
        self.setAndTestTime(2024, 9, 8, 7, 58, expected=["stängt", "måndag", "10:00"])

        # sunday mid day
        self.setAndTestTime(2024, 9, 8, 13, 37, expected=["stängt", "måndag", "10:00"])

        # sunday late
        self.setAndTestTime(2024, 9, 8, 23, 59, expected=["stängt", "måndag", "10:00"])
